...
public class TencentUtil {
     ...
     *
     * @param code
     * @param client [客户端类型 0WX|1QQ]
     */
    public static Map<String, Object> code2session(String code, int client) throws IOException, ParseException {
        String[] API = {
        ...
        String get = HttpUtil.doGet(reqUrl);
